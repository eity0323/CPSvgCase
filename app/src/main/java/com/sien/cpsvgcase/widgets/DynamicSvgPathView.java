 ...
 */
public class DynamicSvgPathView extends View {
    /**
     * Logging tag.
     */
     ...
     */
    public DynamicSvgPathView(Context context) {
        this(context, null);
    }
     ...
     */
    public DynamicSvgPathView(Context context, AttributeSet attrs) {
     ...
     */
    public DynamicSvgPathView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setPaths(final List<Path> paths) {
        for (Path path : paths) {
            this.paths.add(new DynamicSvgUtils.SvgPath(path, paint));
        }
    ...
    public void setPath(final Path path) {
        paths.add(new DynamicSvgUtils.SvgPath(path, paint));
        synchronized (mSvgLock) {
            updatePathsPhaseLocked();
        }
    }
    ...
    public static class AnimatorBuilder {
         ...
         */
        public AnimatorBuilder(final DynamicSvgPathView pathView) {
